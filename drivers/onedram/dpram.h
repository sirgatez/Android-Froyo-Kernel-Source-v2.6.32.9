...
#define DPRAM_ACCESS_ENABLE_ADDRESS					(DPRAM_START_ADDRESS + 0x0002)						// 0x 0000 0004
#define RESERVED1										(DPRAM_ACCESS_ENABLE_ADDRESS+4)					// 0x 0000 0008

#define DPRAM_PDA2PHONE_RAW_HEAD_ADDRESS			(DPRAM_PDA2PHONE_FORMATTED_HEAD_ADDRESS + (DPRAM_FORMATTED_BUFFER_SIZE+4))
#define DPRAM_PDA2PHONE_RAW_TAIL_ADDRESS			(DPRAM_PDA2PHONE_RAW_HEAD_ADDRESS + 2)
#define DPRAM_PDA2PHONE_RFS_HEAD_ADDRESS			(DPRAM_PHONE2PDA_RAW_TAIL_ADDRESS + 4)
#define DPRAM_PDA2PHONE_RFS_TAIL_ADDRESS			(DPRAM_PDA2PHONE_RFS_HEAD_ADDRESS + 4)
#define DPRAM_PDA2PHONE_FORMATTED_HEAD_ADDRESS         (DPRAM_START_ADDRESS + 4)
#define DPRAM_PDA2PHONE_FORMATTED_TAIL_ADDRESS		(DPRAM_PDA2PHONE_FORMATTED_HEAD_ADDRESS + 2)
#define DPRAM_PDA2PHONE_FORMATTED_BUFFER_ADDRESS	(DPRAM_PDA2PHONE_FORMATTED_HEAD_ADDRESS + 4)
#define DPRAM_PDA2PHONE_RAW_BUFFER_ADDRESS			(DPRAM_PDA2PHONE_RAW_HEAD_ADDRESS + 4)
#define DPRAM_PDA2PHONE_RFS_BUFFER_ADDRESS			(DPRAM_PHONE2PDA_RAW_BUFFER_ADDRESS + DPRAM_RAW_BUFFER_SIZE)


#define DPRAM_PHONE2PDA_RAW_HEAD_ADDRESS			(DPRAM_PHONE2PDA_FORMATTED_HEAD_ADDRESS + (DPRAM_FORMATTED_BUFFER_SIZE+4))
#define DPRAM_PHONE2PDA_RAW_TAIL_ADDRESS			(DPRAM_PHONE2PDA_RAW_HEAD_ADDRESS + 2)
#define DPRAM_PHONE2PDA_RFS_HEAD_ADDRESS			(DPRAM_PDA2PHONE_RFS_TAIL_ADDRESS + 4)
#define DPRAM_PHONE2PDA_RFS_TAIL_ADDRESS			(DPRAM_PHONE2PDA_RFS_HEAD_ADDRESS + 4)
#define DPRAM_PHONE2PDA_FORMATTED_HEAD_ADDRESS		(DPRAM_PDA2PHONE_RAW_HEAD_ADDRESS + (DPRAM_RAW_BUFFER_SIZE+4))
#define DPRAM_PHONE2PDA_FORMATTED_TAIL_ADDRESS		(DPRAM_PHONE2PDA_FORMATTED_HEAD_ADDRESS + 2)
#define DPRAM_PHONE2PDA_FORMATTED_BUFFER_ADDRESS	(DPRAM_PDA2PHONE_FORMATTED_HEAD_ADDRESS + 4)
#define DPRAM_PHONE2PDA_RAW_BUFFER_ADDRESS			(DPRAM_PDA2PHONE_RAW_HEAD_ADDRESS + 4)
#define DPRAM_PHONE2PDA_RFS_BUFFER_ADDRESS			(DPRAM_PDA2PHONE_RFS_BUFFER_ADDRESS + DPRAM_RFS_BUFFER_SIZE)

#define DPRAM_RFS_BUFFER_SIZE		1048576
#define DPRAM_RAW_BUFFER_SIZE		12272
#define DPRAM_FORMATTED_BUFFER_SIZE		4092
...
#if defined(CONFIG_ARIES_EUR) || defined(CONFIG_ARIES_LATONA)
#define MAX_MODEM_IMG_SIZE							0x1000000	//10 * 1024 * 1024
